...
[`@aws-sdk/client-glacier`](https://www.npmjs.com/package/@aws-sdk/client-glacier/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glacier@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cPWs1qLjgRLcUC13depGZec+7nbq1QaYLzI93+XJY5cdluuDIfptcdbC2scFC9Ph
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-glacier": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glacier@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-glacier@3.906.0/index.min.mjs": "sha384-cPWs1qLjgRLcUC13depGZec+7nbq1QaYLzI93+XJY5cdluuDIfptcdbC2scFC9Ph"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-glacier/blob/refs/tags/3.906.0/LICENSE
```
